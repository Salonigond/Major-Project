      ...
      <div class="container-fluid" style="background-image: url(back2.jpg);">
        <div class="row">
          ...
          <div class="col-sm-6" ><br><br><br>
            ...
            <img src="image/p2.jpg" height="400px" width="100%" id="bdy"><br><br>
            <img src="s1.jpg" height="400px" width="100%" id="bdy">
          </div>
          <div class="col-sm-6 mt-5" ><brbookingcode.php>
            <form action="bookingcode.php" method="post">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="location" name="location" class="form-control" id="exampleInputLocation1">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <select id="inputservices" name="services" class="form-select">
                      <option selected>Choose...</option>
                      <option>Catering</option>
                      <option>Event Planning and Management</option>
                      <option>Decor and Theming</option>
                      <option>Entertainment</option>
                      <option>Security and Safety Service</option>
                      <option>Registration and Ticketing</option>
                      <option>On-Site Staffing</option>
                    </select>
                  </div>
                  <div class="mb-3">
                    <label for="inputvenue" class="form-label">Venue</label>
                    <select class="form-select"  name="venue" size="3" aria-label="size 3 select example">
                ...
                <button type="submit" class="btn btn-primary">book</button><br><br>
              </form>
